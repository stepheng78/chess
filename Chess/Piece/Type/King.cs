...
namespace Chess
{
    public class King : Piece
    {
        ...
        public override bool SpecialisedMoveBehaviour(PieceMovementContext context)
        {
            ...
            //Plus a max magnitude of 1 (for generic behaviour). 
            //Castling allows King to move a number of tiles in a specific fashion
            ...
            if (
                ...
                ||
                (
                  //Check movement is straight or diagonal 
